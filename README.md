...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/rln3gZsWQ6)
...
```sh
npx nx serve elevate-e-commerce-app
```

To create a production bundle:

```sh
npx nx build elevate-e-commerce-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project elevate-e-commerce-app
```
