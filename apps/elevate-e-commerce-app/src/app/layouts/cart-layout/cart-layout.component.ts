...
import { Cart, CartInterface, CartItem } from '@shared/interfaces/cart-interface/cart-interface';
import { Store } from '@ngrx/store';
import { CartState } from '../../store/cart-data/cart.state';
import { Observable } from 'rxjs';
import { selectCart, selectQuantity, selectTotalPrice, } from '../../store/cart-data/cart.selector';
import { ApplyData, ClearCart, getTotal, updateCount } from '../../store/cart-data/cart.actions';
...
@Component({
  ...
  imports: [CommonModule, TranslateModule, PrimaryBtnComponent, BestSellerComponent, CartComponent,InputTextModule],
